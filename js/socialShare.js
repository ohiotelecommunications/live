...
var socialShare = (function() {
	var http = 'ht'+'tp://', https = 'ht'+'tps://', url_ori = window.location.href, click_target = "zpsocial-share-item", html_url = "/ZCMS_socialshare", //No I18N
		...
		api_url = {
			googleplus	: true,
			stumbleupon	: false,
			pinterest	: http+'widgets.pinterest.com/v1/urls/count.json?source=6&url=',//No I18N
			...
			facebook	: http+'graph.facebook.com/?id=',//No I18N
			twitter		: false,
			tumblr		: http+'api.tumblr.com/v2/share/stats?url=',//No I18N
			buffer		: https+'api.bufferapp.com/1/links/shares.json?url=',//No I18N
			hatena 		: https+'b.hatena.ne.jp/entry.count?url=',//No I18N
			mailru		: http+'connect.mail.ru/share_count?url_list='//No I18N
		};
	...
	*/
	...
	function share(e){
		...
		var shareUrl = {
			...
			stumbleupon:{ url: http+'www.stumbleupon.com/badge/?url=', h: 470, w: 425 } ,//No I18N
			...
			reddit: 	{ url: http+'www.reddit.com/submit?url=',h: 600,w: 600 }, //No I18N
			tumblr: 	{ url: http+'www.tumblr.com/share/link?url=',h: 600, w: 600 },//No I18N
			pocket: 	{ url: https+'getpocket.com/save?url=', h: 600, w: 600}//No I18N
		};
		var obj = shareUrl[media];
		window.open(obj.url + url, '','directories=no, status=no, toolbars = no, menubar=no, scrollbars=no, copyhistory=no, chrome=no, height= '+obj.h+',width='+obj.w);//No I18N
	}
